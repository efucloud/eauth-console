...
import { UserTokenDetail, UserTokenUpdate, UserTokenDetailList, UserTokenCreate } from './user_token.d';
...
//请求方法: POST
//请求地址: /api/user-token
export async function createUserToken<UserTokenDetail>(  data: UserTokenCreate,   options?: { [key: string]: any }) {
  return  request<UserTokenDetail>(`/api/user-token`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
